...
Gem::Specification.new do |spec|
  spec.name          = "sacartists"
  spec.version       = Sacartists::VERSION
  spec.authors       = ["'Sara A'"]
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/salhindi/sacartists"
    spec.metadata["changelog_uri"] = "https://github.com/salhindi/sacartists"
  else
